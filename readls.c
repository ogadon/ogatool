/*
 *  ReadLogicalSectors
 *    http://www.codeguru.com/forum/archive/index.php/t-296963.html
 */
#include <windows.h>
#include <stdio.h>
#include <stdlib.h>
...
------------------------------------------------------------------*/ 
BOOL ReadLogicalSectors (HANDLE hDev, BYTE bDrive, DWORD dwStartSector, WORD wSectors, LPBYTE lpSectBuff)
{
    BOOL fResult;
    DWORD cb;
...
/*------------------------------------------------------------------
    ...
    Comments:
      This function does not validate its parameters.
------------------------------------------------------------------*/ 
BOOL WriteLogicalSectors (HANDLE hDev, BYTE bDrive, DWORD dwStartSector, WORD wSectors, LPBYTE lpSectBuff)
{
    BOOL fResult;
    DWORD cb;
    DIOC_REGISTERS reg = {0};
